...
module "gke_x" {
  ...
  prefix                 = var.prefix
  host_project_id        = var.host_project_id
  service_project_id     = var.service_x_project_id
  service_project_number = var.service_x_project_number
...
module "gke_y" {
  ...
  prefix                 = var.prefix
  host_project_id        = var.host_project_id
  service_project_id     = var.service_y_project_id
  service_project_number = var.service_y_project_number
  gke_security_group     = null
  region                 = var.region_y
